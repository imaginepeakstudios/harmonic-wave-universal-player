...
bun run test        # 767 tests — should be green
...
├── test/
│   ├── unit/                      ← Per-module pure logic — 64 test files, 767 tests
